...
public class Converter {
    ...
    public static void colorIndex (String color) throws IOException {
        int [] RGB = new int [3];
        boolean specific = false;

        File colorsList = new File("src/Colors.txt");
        Scanner checkColors = new Scanner(colorsList);
        while (checkColors.hasNext()) {
            ...
            if (divisions[0].equals(color.toLowerCase())) {
                ...
                System.out.println("HTML Color: " + divisions[0].toUpperCase());
    ...
    public static void convertToHex (int [] RGB) throws IOException {
        String hex;
        ...
        while (checkColors.hasNext()) {
            ...
            if (divisions[1].equals(hex.toLowerCase())) {
                specific = true;
                System.out.println("HTML Color: " + divisions[0]);
                break;
            }
        }
        if (!specific) {
            System.out.println("HTML Color: No specific color associated that fits the description");
        }
    }

    public static void convertToRGB (String hex) throws IOException {
        int [] RGB = new int [3];
